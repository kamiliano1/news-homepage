...
export default function MainNew() {
  return (
    <section className="pt-5 space-y-4 pb-10 md:grid md:grid-mainArticle md:grid-cols-2 md:pt-0 md:space-y-0 col-span-2 md:gap-x-10 md:gap-y-10 md:items-center">
      ...
      <h1 className="text-[clamp(2.5rem,5vw,4.3rem)] md:leading-[clamp(2.5rem,5vw,4.3rem)] font-extraBold md:row-span-2 czcionka">
